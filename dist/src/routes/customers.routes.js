...
var UserRouter = /** @class */ (function () {
    ...
    UserRouter.prototype.getCustomerRoutes = function () {
        ...
        // PROTECTED
        this.router.post("/" + this.path, [this.authMiddleware.verifyAuth(), this.authMiddleware.isAdminAuth()], this.customerController.createCustomer());
        this.router.put("/" + this.path + "/:customerId", [this.authMiddleware.verifyAuth(), this.authMiddleware.isAdminAuth()], this.customerController.updateCustomer());
        this.router.delete("/" + this.path + "/:customerId", [this.authMiddleware.verifyAuth(), this.authMiddleware.isAdminAuth()], this.customerController.deleteCustomer());
    };
    return UserRouter;
}());
